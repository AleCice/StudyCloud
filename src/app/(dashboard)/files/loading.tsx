export default function FilesLoading() {
  return (
    <div className="flex flex-col h-full bg-white animate-in fade-in duration-200 font-mono">
      {/* Toolbar skeleton */}
      <div className="min-h-12 border-b border-black flex items-center px-4 py-2 gap-3 bg-zinc-50 shrink-0">
      ...
      <div className="border-b border-black bg-zinc-100 px-6 py-2 flex items-center gap-8">
      ...
      <div className="flex-1 overflow-auto">
        {[...Array(10)].map((_, i) => (
          <div key={i} className="flex items-center gap-3 px-6 py-3 border-b border-zinc-200 hover:bg-zinc-50">
      ...
      {/* Status bar skeleton */}
      <div className="h-7 border-t border-black bg-zinc-50 px-4 flex items-center shrink-0">
